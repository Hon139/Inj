...
const config = {
    authRequired: false,
    auth0Logout: true,
    secret: process.env.AUTH0_SECRET, // use env in prod
    baseURL: 'http://localhost:3000',
    clientID: '8TJsPYTBZSFjATTHV34d2IiPBhdxIpvt',
    issuerBaseURL: 'https://dev-0ctnrdkqcdk0fjq5.us.auth0.com'
  };
  
  // auth router attaches /login, /logout, and /callback to the baseURL
  app.use(auth(config));
